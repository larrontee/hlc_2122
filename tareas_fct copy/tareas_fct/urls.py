...
from tareas.views import insertar_tareas, listar_tareas, mostrar_tarea,editar_tarea, borrar_tarea, mostrar_tarea2
...
urlpatterns = [
    ...
    path('mostrar_tarea2/<int:tarea_id>/', mostrar_tarea2),
